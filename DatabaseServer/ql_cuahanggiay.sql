...
--
INSERT INTO
  `chitietquyen` (`MaChiTiet`, `TenChiTiet`, `MoTa`)
VALUES
...
CREATE TABLE
  `danhmuc` (
    `MaDM` varchar(11) CHARACTER
    SET
      utf8 COLLATE utf8_unicode_ci NOT NULL,
      `TenDM` varchar(255) CHARACTER
    SET
      utf8 COLLATE utf8_unicode_ci NOT NULL,
...
--
INSERT INTO
  `hang` (`MaHang`, `Ten`, `NgayTao`, `TrangThai`)
VALUES
...
--
INSERT INTO
  `khuyenmai` (`MaKhuyenMai`, `TenKhuyenMai`, `MoTa`, `TiLeGiam`)
VALUES
  ('#', '#', '#', 0),
  (
    'KM_001',
    'Mung sinh nhat cua hang',
    'Cac doi giay ap dung se duoc giam 15%',
    15
  ),
  (
    'KM_002',
    'Mung worldcup ',
    'Cac doi giay ap dung se duoc giam 10%',
    10
  ),
  (
    'KM_003',
    'Mung viet nam vo dich Sea Game',
    'Cac doi giay ap dung se duoc giam 20%',
    20
  ),
  (
    'KM_005',
    'Mua Euro',
    'Cac giay ap dung duoc giam 7%',
    7
  );
...
VALUES
  (
    '001',
    'ADIDAS NEMEZIZ 19.3 TF TRẮNG XANH MUTATOR 2020 PAC',
    'KM_001',
    '19-05-2023/LOGO.jpg                      ',
    'DM-1',
    '&lt;p&gt;helloo&lt;/p&gt;\r\n',
  ...
  (
    '002',
    'ADIDAS COPA SENSE.3 TF GAME DATA PACK - GZ1366',
    'KM_002',
    '002.jpg ',
    'DM-1',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '003',
    'ADIDAS PREDATOR EDGE.3 L TF - GV8527 Data Game Pac',
    'KM_002',
    '003.jpg  ',
    'DM-1',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '004',
    ' ADIDAS PREDATOR EDGE .1 TF GW9997 SAPPHIRE EDGE',
    'KM_003',
    '004.jpg ',
    'DM-1',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '005',
    'ADIDAS X SPEEDPORTAL.1 TF GW8973 GAME DATA PACK - ',
    'KM_002',
    '005.jpg  ',
    'DM-1',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '006',
    'ADIDAS X SPEEDPORTAL .1 FG GW8426 GAME DATA PACK',
    'KM_001',
    '006.jpg ',
    'DM-2',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '007',
    'ADIDAS PREDATOR MUTATOR 20.1 FG EG1602',
    '#',
    '007.jpg ',
    'DM-2',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '008',
    'ADIDAS X SPEEDFLOW .1 FG GW7456 DIAMOND EDGE PACK ',
    '#',
    '008.jpg',
    'DM-2',
    '#',
  ...
  (
    '010',
    'NIKE ZOOM MERCURIAL VAPOR 15 PRO TF TRẮNG',
    '#',
    '010.jpg ',
    'DM-1',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '012',
    'NIKE TIEMPO LEGEND 9 ELITE FG CZ8482-075 RECHARGE ',
    '#',
    '012.jpg',
    'DM-2',
    '#',
  ...
  (
    '013',
    'NIKE MERCURIAL SUPERFLY 8 ELITE FG CV0958-760 MOTI',
    '#',
    '013.jpg ',
    'DM-2',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '016',
    ' NIKE TIEMPO LEGEND 9 ACADEMY TF WORLD CUP',
    '#',
    '016.jpg ',
    'DM-1',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '017',
    'NIKE TIEMPO REACT LEGEND 9 PRO TF WORLD CUP',
    '#',
    '017.jpg',
    'DM-1',
    '#',
  ...
  (
    '018',
    'NIKE TIEMPO REACT LEGEND 9 PRO TF',
    '#',
    '018.jpg ',
    'DM-1',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '019',
    ' NIKE ZOOM MERCURIAL VAPOR 15 PRO TF HỒNG',
    '#',
    '019.jpg ',
    'DM-1',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '020',
    '  PUMA ULTRA ULTIMATE CAGE TF 10689301 FASTEST PAC',
    'KM_001',
    '020.jpg ',
    'DM-1',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '021',
    'PUMA ULTRA 1.3 FG/AG 106477-02 FASTER FOOTBALL PAC',
    '#',
    '021.jpg ',
    'DM-2',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '022',
    'PUMA FUTURE Z NEYMAR X COPA AMERICA FG 10684201',
    '#',
    '022.jpg ',
    'DM-2',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '032',
    'GIÀY PAN VIGOR X LTD XANH DƯƠNG',
    '#',
    '032.jpg ',
    'DM-4',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '033',
    'GIÀY PAN WAVE II LEGEND IC ĐEN',
    '#',
    '033.jpg ',
    'DM-4',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '035',
    'GIÀY PAN SUPER SONIC IC ĐẾ BẰNG',
    '#',
    '035.jpg',
    'DM-4',
    '#',
  ...
  (
    '036',
    'PHANTOM VSN ACADEMY BRIGHT CRIMSON IC',
    '#',
    '035.jpg  ',
    'DM-4',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '041',
    'NIKE JR. MERCURIAL VAPOR 14 ACADEMY TF CV0822-474 ',
    '#',
    '041.jpg ',
    'DM-3',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '042',
    'NIKE PHANTOM VNM ACADEMY TF KIDS AO0377-600',
    '#',
    '042.jpg',
    'DM-3',
    '#',
  ...
  (
    '043',
    'NIKE PHANTOM VSN ACADEMY TF KIDS AR4343-060',
    '#',
    '043.jpg ',
    'DM-3',
    '&lt;p&gt;#&lt;/p&gt;\r\n',
  ...
  (
    '044',
    '  NIKE TIEMPO LEGEND 9 ACADEMY TF FOR KIDS',
    '#',
    '044.jpg',
    'DM-3',
    '#',
...
--
INSERT INTO
  `sosize` (`MaSP`, `SoLuong`, `Size`, `GiaBan`)
VALUES
  ('002', 45778, 40, 20000),
  ('002', 0, 41, 21000),
  ('002', 0, 42, 22000),
...
--
ALTER TABLE `chitietdonhang` ADD PRIMARY KEY (`MaSP`, `MaDonHang`),
ADD KEY `MaDonHang` (`MaDonHang`);

--
-- Chỉ mục cho bảng `chitietphieunhap`
--
ALTER TABLE `chitietphieunhap` ADD KEY `MaPhieu` (`MaPhieu`),
ADD KEY `chitietphieunhap_ibfk_2` (`MaSP`);

--
-- Chỉ mục cho bảng `chitietquyen`
--
ALTER TABLE `chitietquyen` ADD PRIMARY KEY (`MaChiTiet`);
...
--
ALTER TABLE `giohang` ADD PRIMARY KEY (`MaTaiKhoan`, `MaSP`, `Size`),
ADD KEY `MaSP` (`MaSP`);

--
-- Chỉ mục cho bảng `hang`
--
ALTER TABLE `hang` ADD PRIMARY KEY (`MaHang`);

--
-- Chỉ mục cho bảng `khachhang`
--
ALTER TABLE `khachhang` ADD PRIMARY KEY (`MaKhach`),
ADD KEY `MaTaiKhoan` (`MaTaiKhoan`);
...
--
ALTER TABLE `phanquyen` ADD PRIMARY KEY (`MaQuyen`, `MaChiTiet`),
...
--
ALTER TABLE `quyen` ADD PRIMARY KEY (`MaQuyen`);
...
--
ALTER TABLE `sosize` ADD PRIMARY KEY (`MaSP`, `Size`);

--
-- Chỉ mục cho bảng `taikhoan`
--
ALTER TABLE `taikhoan` ADD PRIMARY KEY (`MaTaiKhoan`),
ADD KEY `Quyen` (`Quyen`);
...
--
ALTER TABLE `donhang` MODIFY `MaDonHang` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 62;

--
-- AUTO_INCREMENT cho bảng `khachhang`
--
ALTER TABLE `khachhang` MODIFY `MaKhach` int (50) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 17;

--
-- AUTO_INCREMENT cho bảng `phieunhaphang`
--
ALTER TABLE `phieunhaphang` MODIFY `MaPhieu` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 20;

--
-- AUTO_INCREMENT cho bảng `taikhoan`
--
ALTER TABLE `taikhoan` MODIFY `MaTaiKhoan` int (50) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 23;
...
--
ALTER TABLE `chitietdonhang` ADD CONSTRAINT `chitietdonhang_ibfk_2` FOREIGN KEY (`MaSP`) REFERENCES `sanpham` (`MaSP`),
ADD CONSTRAINT `chitietdonhang_ibfk_3` FOREIGN KEY (`MaDonHang`) REFERENCES `donhang` (`MaDonHang`);

--
-- Các ràng buộc cho bảng `chitietphieunhap`
--
ALTER TABLE `chitietphieunhap` ADD CONSTRAINT `chitietphieunhap_ibfk_2` FOREIGN KEY (`MaSP`) REFERENCES `sanpham` (`MaSP`),
ADD CONSTRAINT `chitietphieunhap_ibfk_3` FOREIGN KEY (`MaPhieu`) REFERENCES `phieunhaphang` (`MaPhieu`);

--
-- Các ràng buộc cho bảng `donhang`
--
ALTER TABLE `donhang` ADD CONSTRAINT `donhang_ibfk_1` FOREIGN KEY (`MaTaiKhoan`) REFERENCES `taikhoan` (`MaTaiKhoan`);

--
-- Các ràng buộc cho bảng `giohang`
--
ALTER TABLE `giohang` ADD CONSTRAINT `giohang_ibfk_1` FOREIGN KEY (`MaTaiKhoan`) REFERENCES `taikhoan` (`MaTaiKhoan`),
ADD CONSTRAINT `giohang_ibfk_2` FOREIGN KEY (`MaSP`) REFERENCES `sanpham` (`MaSP`);

--
-- Các ràng buộc cho bảng `khachhang`
--
ALTER TABLE `khachhang` ADD CONSTRAINT `khachhang_ibfk_1` FOREIGN KEY (`MaTaiKhoan`) REFERENCES `taikhoan` (`MaTaiKhoan`);

--
-- Các ràng buộc cho bảng `nhanvien`
--
ALTER TABLE `nhanvien` ADD CONSTRAINT `nhanvien_ibfk_1` FOREIGN KEY (`MaTaiKhoan`) REFERENCES `taikhoan` (`MaTaiKhoan`);

--
-- Các ràng buộc cho bảng `phanquyen`
--
ALTER TABLE `phanquyen` ADD CONSTRAINT `phanquyen_ibfk_1` FOREIGN KEY (`MaQuyen`) REFERENCES `quyen` (`MaQuyen`),
...
--
ALTER TABLE `phieunhaphang` ADD CONSTRAINT `phieunhaphang_ibfk_1` FOREIGN KEY (`MaHang`) REFERENCES `hang` (`MaHang`),
ADD CONSTRAINT `phieunhaphang_ibfk_2` FOREIGN KEY (`MaTaiKhoan`) REFERENCES `taikhoan` (`MaTaiKhoan`);

--
-- Các ràng buộc cho bảng `sanpham`
--
ALTER TABLE `sanpham` ADD CONSTRAINT `sanpham_ibfk_1` FOREIGN KEY (`MaHang`) REFERENCES `hang` (`MaHang`),
...
--
ALTER TABLE `sosize` ADD CONSTRAINT `sosize_ibfk_1` FOREIGN KEY (`MaSP`) REFERENCES `sanpham` (`MaSP`);

--
-- Các ràng buộc cho bảng `taikhoan`
--
ALTER TABLE `taikhoan` ADD CONSTRAINT `taikhoan_ibfk_1` FOREIGN KEY (`Quyen`) REFERENCES `quyen` (`MaQuyen`);
