...
if (isset($_GET['MaTK'])) {
    ...
    ?>
        <tr>
            ...
            <td>
                <div class="TinhTrang<?php if ($data[$i][3] == 0) {
                                            echo " chuaXuLy";
                                        }
                                        if ($data[$i][3] == 2) {
                                            echo " daBiHuy";
            ...
            <td><a href="./admin/template/template_content/ChiTietDonHang.php?PQ=User&CT=<?php echo $data[$i][0] ?>&MaTK=<?php echo $data[$i][1] ?>&Date=<?php echo $data[$i][2] ?>&TT=<?php echo $data[$i][4] ?>">
