    ...
    <table id="tbl_km">
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="./template/template_content/Hang/xulyHang.php?cn=Edit&MaHang=<?php echo $data[$i][0] ?>&TenHang=<?php echo $data[$i][1] ?>">
                        <div id="edit_km">Sửa</div>
                    </a>
                    <a href="./template/template_content/Hang/xulyHang.php?cn=Delete&MaHang=<?php echo $data[$i][0] ?>">
