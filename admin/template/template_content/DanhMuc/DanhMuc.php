        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="./template/template_content/DanhMuc/xulyDanhMuc.php?cn=Delete&MaDanhMuc=<?php echo $data[$i][0] ?>">
                        <div id="delete_dm" onclick="return confirm(`Bạn có muốn xóa không ?`)">Xóa</div>
                    </a>
