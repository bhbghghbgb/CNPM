...
$(document).ready(function () {
    $.ajax({
        ...
        success: function (response) {
            google.charts.setOnLoadCallback(function () { VeBieuDoCotDaBan(response) });
        }
    });
    $.ajax({
        url: './template/template_content/ajaxtrangchu.php',
        ...
        success: function (response) {
            google.charts.setOnLoadCallback(function () { VeBieuDoTronSPDaBan(response) });
        }
    });
    $.ajax({
        url: './template/template_content/ajaxtrangchu.php',
        ...
        success: function (response) {
            google.charts.setOnLoadCallback(function () { VeBieuDoTronHangDaBan(response) });
        }
    });
});
...
$(document).ready(function () {
    ...
    //js vẽ biểu đồ cột
    document.getElementById('BieuDoCotSPDaBan-sel').addEventListener('change', function () {
        var valueQuy = document.getElementById('BieuDoCotSPDaBan-sel').value;
        $.ajax({
            url: './template/template_content/ajaxtrangchu.php',
            method: 'POST',
            data: {daban:true, quarter: valueQuy },
            success: function (response) {
                google.charts.setOnLoadCallback(function () { VeBieuDoCotDaBan(response, valueQuy) });
            }
        });
    });

    //js gọi hàm vẽ biểu đồ tròn sp
    document.getElementById('BieuDoTronSPDaBan-sel').addEventListener('change', function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                google.charts.setOnLoadCallback(function () { VeBieuDoTronSPDaBan(response, dataName) });
            }
        });
    });
...
function VeBieuDoTronHangDaBan(dataPhanTram) {
    ...
    var chart = new google.visualization.PieChart(document.getElementById('BieuDoTronHangDaBan'));
...
function VeBieuDoTronSPDaBan(dataPhanTram, valueHang = null) {
    ...
    var chart = new google.visualization.PieChart(document.getElementById('BieuDoTronSPDaBan'));
    chart.draw(data, options);
...
function VeBieuDoCotDaBan(dataDoanhThu, quarter = null) {
    ...
    var chart = new google.visualization.ColumnChart(document.getElementById("BieuDoCotSPDaBan"));
...
$(document).ready(function () {
    $.ajax({
        ...
        data: { quarter: 0 },
        success: function (response) {
            google.charts.setOnLoadCallback(function () { VeBieuDoCotNhap(response) });
        }
    });
    $.ajax({
        url: './template/template_content/ajaxtrangchu.php',
        ...
        data: { hang: 0 },
        success: function (response) {
            google.charts.setOnLoadCallback(function () { VeBieuDoTronSPNhap(response) });
        }
    });
    $.ajax({
        url: './template/template_content/ajaxtrangchu.php',
        ...
        success: function (response) {
            google.charts.setOnLoadCallback(function () { VeBieuDoTronHangNhap(response) });
        }
    });
});
...
$(document).ready(function () {
    ...
    //js vẽ biểu đồ cột
    document.getElementById('BieuDoCotSPNhap-sel').addEventListener('change', function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                google.charts.setOnLoadCallback(function () { VeBieuDoCotNhap(response, valueQuy) });
            }
        });
    });

    //js gọi hàm vẽ biểu đồ tròn sp
    document.getElementById('BieuDoTronSPNhap-sel').addEventListener('change', function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                google.charts.setOnLoadCallback(function () { VeBieuDoTronSPNhap(response, dataName) });
            }
        });
    });
...
function VeBieuDoTronSPNhap(dataPhanTram, valueHang = null) {
    ...
    document.getElementById('SanPhamNhapNhieu').innerHTML = "Sản phẩm nhập nhiều nhất: " + maxProductName + "<br> Nhập " + maxProductQuantity + " Sản phẩm.";
}
...
function VeBieuDoCotNhap(dataDoanhThu, quarter = null) {
    ...
    var chart = new google.visualization.ColumnChart(document.getElementById("BieuDoCotSPNhap"));
    chart.draw(view, options);
}
